...
class DairyReportFormV1(forms.Form):
    ...
    r7_5 = forms.IntegerField(label="小便", widget=number_input())
    ...
    r7_9 = forms.IntegerField(label="大便", widget=number_input())
    ...
    r8_5 = forms.IntegerField(label="輔具使用", widget=forms.RadioSelect(choices=(
        ("0", "無"), ("1", "甜甜圈墊"), ("2", "氣墊床"), ("3", "其他"), )))
    r8_5e = forms.CharField(label="輔具使用/其他", widget=text_input(placeholder="說明"), required=False)

    r9_1 = forms.IntegerField(label="異常狀態", widget=forms.RadioSelect(choices=(
